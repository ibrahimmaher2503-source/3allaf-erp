...
**Active phase:** P0 Phase 1 is merged as `3bae98c`: legacy approved-sale settlement snapshots are reconciled from captured payments, with POS unpaid/partial/full/credit-limit verification complete. No other P0 slice is authorized until the Supervisor explicitly opens it.
