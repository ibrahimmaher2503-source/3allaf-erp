...
**Active phase: P0 Phase 7, inventory adjustments, is merged as `c1c0b7e` after Safety and Lead review. P0.8 remains unopened; P1 remains blocked until the P0 full-day MariaDB end-to-end gate passes.
