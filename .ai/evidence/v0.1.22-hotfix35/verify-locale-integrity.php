...
$fail = static function (string $message): never {
    fwrite(STDERR, "HOTFIX35_LOCALE_INTEGRITY=FAIL {$message}\n");
    exit(1);
};
...
echo 'HOTFIX35_LOCALE_INTEGRITY=PASS json=6115 php_leaves=244 parity=exact protected_tokens=exact'.PHP_EOL;
